/*
  ...
  gengetopt --input cmdline.ggo Makefile.am ../configure.ac 
...
const char *gengetopt_args_info_full_help[] = {
  ...
  "  -n, --new-key=STRING     New management key to use for action set-mgm-key",
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->serial_help = gengetopt_args_info_full_help[21] ;
  args_info->valid_days_help = gengetopt_args_info_full_help[22] ;
  args_info->pin_help = gengetopt_args_info_full_help[23] ;
  args_info->new_pin_help = gengetopt_args_info_full_help[24] ;
  args_info->pin_policy_help = gengetopt_args_info_full_help[25] ;
  args_info->touch_policy_help = gengetopt_args_info_full_help[26] ;
  args_info->id_help = gengetopt_args_info_full_help[27] ;
  args_info->format_help = gengetopt_args_info_full_help[28] ;
  args_info->sign_help = gengetopt_args_info_full_help[29] ;
  ...
  while (1)
    {
      ...
      switch (c)
        ...
        case 'H':	/* Hash to use for signatures.  */
          ...
          break;
        case 'n':	/* New management key to use for action set-mgm-key.  */
